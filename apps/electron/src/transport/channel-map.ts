...
export const CHANNEL_MAP = {
  ...
  getSessionPage: invoke(RPC_CHANNELS.sessions.GET_PAGE),
  ...
  'symphony.createIssue': invoke(RPC_CHANNELS.symphony.CREATE_ISSUE),
  'symphony.onChanged': listener(RPC_CHANNELS.symphony.CHANGED),
