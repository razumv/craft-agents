...
const EXPECTED_CHANNELS: string[] = [
  ...
  'automations:admissionCapabilities',
  'automations:admissionClaim',
  'automations:admissionDeliver',
  'automations:admissionInspect',
  'automations:admissionRecover',
  'automations:changed',
  'automations:delete',
  ...
  'statuses:reorder',
  'symphony:changed',
  'symphony:createIssue',
  'symphony:generateConfig',
  'symphony:projectDesk',
  'symphony:refresh',
  'symphony:shadow',
  'symphony:status',
  'symphony:stop',
